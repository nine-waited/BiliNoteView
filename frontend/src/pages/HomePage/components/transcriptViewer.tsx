...
const TranscriptViewer = () => {
  ...
  return (
      <div className="transcript-viewer flex h-full min-h-0 w-full flex-col rounded-md border bg-white p-4 shadow-sm">
              ...
              <div className="space-y-1">
                {task.transcript.segments.map((segment, index) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 break-words text-sm leading-relaxed text-slate-700">
                        {segment.speaker && (
